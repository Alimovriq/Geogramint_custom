...
6. Комманда `reset-scan` очистит `cache_telegram` и все объекты базы данных.
7. Комманда `print-db-elements` с одним аргументом name_collection (название коллекции, стандартно "Users" и "Groups") для вывода объектов базы данных в консоль.
8. Комманда `clear-db-elements` очистит все объекты базы данных.
