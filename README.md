...
7. Комманда `print-db-elements` с одним аргументом name_collection (название коллекции, стандартно "Users" и "Groups") для вывода объектов БД в консоль.
8. Комманда `clear-db-elements` очистит все обьекты БД.
